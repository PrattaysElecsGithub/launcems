...
# Made Proudly in India, By Prattay Sarkar, aka. Prattay's Elecs GITHUB
...
print(Fore.GREEN + "|___________________________|\n")  # TODO: Fix Github Respoitory upload problem
print(Fore.BLUE + "|+- Trying To Start LaunceMS Server...")
